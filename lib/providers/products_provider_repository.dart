...
class ProductsProviderRepository{
  ProductsProviderRepository._privateConstructor();
  static final ProductsProviderRepository instance = ProductsProviderRepository._privateConstructor();

  Future<List<ProductModel>> getProducModel({required int x }){
